        ...
        <section className="container login-page">
                <div style={{height:'100vh'}} className="d-flex flex-column align-items-center justify-content-center">
                    <div className="auth-container">
                        {passwordReset ?
                            <div className="auth-container--password-reset">
                        ...
                        <form className="auth-container__auth-form" onSubmit={(e) => handleSubmit(e)}>
                            <input className="auth-container__auth-form--input" name='email' ref={emailRef} type="email" placeholder="Email" required/>
                            <div className="auth-container__auth-form__password-container">
                                ...
                                <span onClick={() => setShowPassword(!showPassword)} className="auth-container__auth-form__password-container--show-password-icon">
                                    {showPassword ?
                            ...
                            <div className="auth-container__auth-form__submit-container">
                                <input className="auth-container__auth-form__submit-container--button" type="submit" value="Login" />
