    ...
    return (
        <section className="form-section auth-page container">
            <div className="form-section__container">
                <h1 className="form-section__container--title">Password reset</h1>
                <form className="form-section__container__form" onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <div className="form-section__container__form__password-container">
                        <input className="form-section__container__form__password-container--input form-section__container__form--input" name='password' ref={passwordConfirmationRef} type={showPassword2 ? 'text' : 'password'} placeholder="Confirm password" required/>
                    ...
                    <div className="form-section__container__form__submit-container">
                        <input className="form-section__container__form__submit-container--button" type="submit" value="Reset password" />
