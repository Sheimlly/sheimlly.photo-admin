    ...
    return (
        <section className='container form-section'>
            <div className='form-section__container'>
                <h1 className='form-section__container--title'>Add User</h1>
                <form className='form-section__container__form' onSubmit={(e) => addUser(e)}>
                    <input className='form-section__container__form--input' type='email' ref={email} placeholder='Email' required />
                    {emailError ? <span className='form-section__container__form--error'>{errorMessage}</span> : ''}

                    <div className="form-section__container__form__password-container">
                        <input className="form-section__container__form__password-container--input form-section__container__form--input" name='password' ref={password} type={showPassword ? 'text' : 'password'} placeholder="Password" required/>
                    ...
                    <div className="form-section__container__form__password-container">
                        <input className="form-section__container__form__password-container--input form-section__container__form--input" name='password' ref={password2} type={showPassword2 ? 'text' : 'password'} placeholder="Confirm password" required/>
                        <span onClick={() => setShowPassword2(!showPassword2)} className="form-section__container__form__password-container--show-password-icon">
                            {showPassword2 ?
                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
                                    <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
                                        <path d="M2370 4184 c-589 -70 -1135 -342 -1715 -855 -203 -179 -537 -540
                    ...
                    {!passwordMatch ? <span className='form-section__container__form--error'>Passwords must be the same</span> : ''}
                    ...
                    <div className='form-section__container__form__submit-container'>
                        <input className='form-section__container__form__submit-container--button' type='submit' value='Add user' />
